...
The original dataset was processed and simplified for this project.
Only a subset of the available parameters was included, and measurement
uncertainties were not considered in the analysis.

The analysis includes planetary, stellar, discovery, and spatial variables
such as:
